...
let n = fio.readInt()
let k = fio.readInt()
var combinationSet = Set<String>()
var visited = Array(repeating: false, count: n + 1)
var cards = [String]()

for _ in 0..<n {
    let card = fio.readString()
    cards.append(card)
}

var answer = 0
func makeCombination(combination: [String] = []) {
    var combination = combination
    if combination.count == k {
        combinationSet.insert(combination.joined())
        return
    }
